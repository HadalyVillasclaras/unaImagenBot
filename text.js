...
let textPDF = fs.readFileSync('La_vuelta_al_mundo_en_80_dias_-_Jules_Verne.pdf');
let text;
text = pdfParse(textPDF).then(function (data) {
    text = data.text;
    return text;
...
// Hace cuatro años que vivo en esta  de Phileas casa. del sur  El edificio es moderno y de construcción reciente. Me gusta mucho el exterior, ya que tiene unos colores muy atractivos y buen aspecto.\
